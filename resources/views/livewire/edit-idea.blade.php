<div x-init="
    ...
    <div class="flex items-end justify-center min-h-screen ">
        ...
        <div x-show.transition.opacity.origin.bottom.duration.400ms="isOpen"
            ...
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                <h3 class="text-lg text-center ">Edit idea</h3>
                <p
                   class="mt-4 text-xs leading-4 text-center text-gray-500">
                    You have one hour to edit your
                    idea from
