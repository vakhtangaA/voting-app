...
>
  ...
  >
          ...
          >
            ...
            <div class="ml-4">
              <div class="line-clamp-6">
                <span
                  class="font-semibold">{{ $notification->data['user_name'] }}</span>
                commented on
                <span
                  class="font-semibold">{{ $notification->data['idea_title'] }}</span>:
    ...
    @elseif($isLoading)
      @foreach (range(1, $notificationCount) as $item)
        <li
          class="animate-pulse flex items-center transition duration-150 ease-in px-5 py-3"
        >
