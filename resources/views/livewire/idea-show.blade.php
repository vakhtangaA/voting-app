            ...
            <div class="w-full mx-2">
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                             class="hidden font-bold text-gray-900 md:block">
                            {{ $idea->user->name }}</div>
                    ...
                    <div class="flex items-center mt-4 space-x-2 md:mt-0"
                        ...
                        <button @click="isOpen = !isOpen"
                            ...
                            <ul x-show.transition.origin.top.left="isOpen"
                    ...
                    <div
                         class="flex items-center mt-4 md:hidden md:mt-0">
                        <div
