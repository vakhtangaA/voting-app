      ...
      <div class="flex px-2 py-6">
        ...
        <div class="mx-4">
          ...
          <div class="mt-3 text-gray-600 line-clamp-3">
            ...
            perferendis? Eum eligendi nulla aliquam numquam! Nobis, tempore rerum autem accusamus
            perspiciatis laudantium at excepturi sint placeat nulla beatae qui aliquam quibusdam
            corrupti vel dolor praesentium quam dolore itaque deleniti quod in ut earum. Cum fuga ea
            molestias nesciunt soluta sint maxime, magnam dolorum reprehenderit autem, vel ipsa?
            Vitae
            vel quos quaerat, fugit in reiciendis alias perspiciatis esse numquam facere cum veniam
            beatae voluptatem eos amet vero laborum error. Dolor distinctio temporibus iure,
            repellendus porro molestiae deleniti quibusdam?
          </div>
      ...
      <div class="flex px-2 py-6">
        ...
        <div class="mx-4">
          ...
          <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex items-center space-x-2">
              <div
                class="w-auto px-4 py-2 font-bold leading-none text-center text-white uppercase rounded-full bg-green text-xxs h-7">
                Implemented</div>
              <button
                class="relative px-3 py-2 transition duration-150 ease-in bg-gray-100 rounded-full hover:bg-gray-200 h-7">
                <svg fill="currentColor" width="24" height="6">
      ...
      <div class="flex px-2 py-6">
        ...
        <div class="mx-4">
          ...
          <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex items-center space-x-2">
              <div
                class="w-auto px-4 py-2 font-bold leading-none text-center text-white uppercase rounded-full bg-purple text-xxs h-7">
                Considering</div>
              <button
                class="relative px-3 py-2 transition duration-150 ease-in bg-gray-100 rounded-full hover:bg-gray-200 h-7">
                <svg fill="currentColor" width="24" height="6">
