<x-app-layout>
  ...
  <div class="my-6 space-y-6 ideas-container">
    ...
    <div class="flex flex-col flex-1 px-2 py-6 md:flex-row">
      <div class="flex-none mx-4 md:mx-0">
        <a href="#">
          <img src="https://avatars.dicebear.com/api/avataaars/dsa.svg" alt="avatar"
            class="w-14 h-14 rounded-xl">
        </a>
      </div>
      <div class="flex flex-col justify-between w-full mx-4">
        <h4 class="text-xl font-semibold">
          <a href="#" class="hover:underline">A Second random title can go here</a>
        </h4>
        <div class="mt-3 text-gray-600 line-clamp-3">
          Lorem ipsum dolor sit amet
        </div>
  ...
  <div class="flex flex-col flex-1 px-2 py-6 md:flex-row">
    <div class="flex-none mx-4 md:mx-0">
      <a href="#">
        <img src="https://avatars.dicebear.com/api/avataaars/dsssa.svg" alt="avatar"
          class="w-14 h-14 rounded-xl">
      </a>
    </div>
    <div class="flex flex-col justify-between w-full mx-4">
      <h4 class="text-xl font-semibold">
        <a href="#" class="hover:underline">A third random title can go here</a>
      </h4>
      <div class="mt-3 text-gray-600 line-clamp-3">
        Lorem ipsum dolor sit amet
      </div>
