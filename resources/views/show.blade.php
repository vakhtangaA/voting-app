    ...
    <div class="flex flex-col flex-1 px-4 py-6 md:flex-row">
      ...
      <div class="w-full mx-2">
        ...
        <div class="mt-3 text-gray-600">
          ...
          adipisicing
          elit. Amet officia doloribus quibusdam dolorem quod velit repellat obcaecati doloremque,
          nulla iusto modi hic. Dolore possimus consequuntur et recusandae laboriosam? Esse, culpa.
        </div>
          ...
          <div class="flex items-center mt-4 space-x-2 md:mt-0" x-data="{ isOpen: false }">
            ...
            <button @click="isOpen = !isOpen"
              ...
              <ul x-cloak x-show.transation.origin.top.left="isOpen" @click.away="isOpen = false"
                ...
                class="absolute right-0 py-3 font-semibold text-left bg-white md:ml-8 w-44 shadow-dialog rounded-xl top-8 md:top-6 md:left-0">
                <li><a href="#"
  ...
  <div class="flex items-center justify-between mt-6 buttons-container">
    <div class="flex flex-col items-center space-x-4 md:flex-row md:ml-6">
      ...
      <div class="relative" x-data="{isOpen: false}">
        ...
        <div x-cloak x-show.transation.origin.top.left="isOpen" @click.away="isOpen = false"
          @keydown.escape.window="isOpen = false"
          class="absolute z-20 mt-2 text-sm font-semibold text-left bg-white w-60 md:w-76 shadow-dialog rounded-xl">
          <form action="#" class="px-4 py-6 space-y-4">
            <div class="space-y-2">
              <div>
